...
-- Chave padrao de OTServ. NAO trocar: todo servidor baseado em OTServ/TFS/Canary
-- espera esta chave, e sobrescreve-la quebra o login em todos eles de uma vez
-- (o servidor responde "RSA Decrypt Failed" e derruba a conexao).
...
-- Chave do servidor Zanera. NAO e mais a chave original do dump (aquela era a
-- chave real da CipSoft de 2006, vazada e publica desde entao -- 1024 bits
-- sem padding em canal texto claro nao segura nada se o modulo e conhecido).
-- Gerada em 2026-09-18: RSA 2048 bits / e=65537, usada com OAEP-SHA256 (o
-- servidor deixou de aceitar o bloco textbook de 128 bytes). A chave de 1024
-- de 2026-09-08 ficou em tibia77-staging/game-*/tibia.pem.bak-1024-2026-09-18.
ZANERA_RSA = '2228893194165041859775825962902650275531511061094255514593065306319469' ..
    '4734917976025199570963005101207158698435270211027952649655273883837751' ..
    '0611236085021072388990594765909205575863019536628193171252194279926264' ..
    '7496070062241568024896711916158303797453565632544029091752612177080164' ..
    '9710975681779353439671341601227658066884852100753191023460190017568595' ..
    '8190347253483932504838766326405704463765737331124219313777101604361313' ..
    '8800107386574893425975707965415225234846145536431807508070510631623061' ..
    '0811554262961068799854039772024644701774153231652465724101474505590690' ..
    '903485474921897302056901580452780219347357846999118612549'
